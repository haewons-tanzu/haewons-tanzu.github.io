...
```text
E0517 14:58:57.745454 1 controller.go:257] controller-runtime/controller "msg"="Reconciler error" "error"="failed to reconcile AzureMachine: failed to create virtual machine: failed to create VM tkg-mgmt-jp-md-0-b7nfk in resource group rg-japan-east: compute.VirtualMachinesClient#CreateOrUpdate: Failure sending request: StatusCode=400 -- Original Error: Code=\"InvalidAvailabilityZone\" Message=\"The zone(s) '1' for resource 'Microsoft.Compute/virtualMachines/tkg-mgmt-jp-md-0-b7nfk' is not supported. The supported zones for location 'koreacentral' are ''\"" "controller"="azuremachine" "name"="tkg-mgmt-jp-md-0-b7nfk" "namespace"="tkg-system"​
I0517 14:59:12.768269 1 azuremachine_controller.go:227] controllers/AzureMachine "msg"="Reconciling AzureMachine" "AzureCluster"="tkg-mgmt-jp" "azureMachine"="tkg-mgmt-jp-control-plane-p4842" "cluster"="tkg-mgmt-jp" "machine"="tkg-mgmt-jp-control-plane-sphph" "namespace"="tkg-system"​
```
